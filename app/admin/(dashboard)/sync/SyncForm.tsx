  ...
  return (
    <Card className="p-6">
      ...
      <div className="mt-4 flex items-center gap-2">
        <code className="flex-1 truncate rounded-lg bg-gold/[0.07] px-3 py-2 text-sm">{feedUrl}</code>
    ...
    <Card className="p-6">
      ...
      <form onSubmit={onSave} className="mt-4 flex flex-col gap-3 sm:flex-row">
        ...
        <div className="flex gap-2">
          ...
          <button type="button" disabled={pending} onClick={onSyncNow} className="admin-btn admin-btn-outline">
            Sync now
          </button>
        </div>
      </form>
